...
class Test_Ubuntu(TestCase):
    ...
    def test001_uptime(self):
        ...
        **Test Scenario**
        #. Check uptime form system file located at  /proc/uptime
    ...
    def test02_service_install(self):
        ...
        **Test Scenario**
        ...
        if mysys == 'my_init':
            ...
            self.info('something unexpected occured while checking system type')
    ...
    def test005_apt_install_version(self):
        ...
        **Test Scenario**
        ...
        #. check version of wget after insalling it
    ...
    def test008_service_start(self):
        ...
        **Test Scenario**
        ...
        if cront_status is True:
            self.info('starting cron service after finishing testing by service_start method')
            self.ubuntu.service_stop("cron")
    ...
    def test010_service_restart(self):
        ...
        **Test Scenario**
        ...
        self.assertTrue(self.ubuntu.service_status('cron'))
        if cront_status is True:
            self.info('starting cron service after finishing testing  service_start method')
            self.ubuntu.service_stop("cron")
    ...
    def test015_apt_get_cache_keys(self):
        ...
        **Test Scenario**
        ...
        #. Compare the package name of step2 should be included in keys form step 1
        """
    ...
    def test026_service_uninstall(self):
        ...
        **Test Scenario**
        ...
        #. Verify the cron config file doest not exist after uninstalling service
        ...
        mysys = None
        zdb_service_file = False
        self.info('installing zdb form builder')
        j.builders.db.zdb.install()
        self.info('checking system is systemd or not ')
        mysys = self._check_init_process()
        if mysys == 'my_init':
        ...
        self.ubuntu.service_uninstall('zdb')
        self.info('Verify the zdb config file doest not exist after uninstalling service ')
        if mysys == 'my_init':
    ...
    def test027_whoami(self):
        ...
        **Test Scenario**
        #. Get user from tested method
        #. Get user from whoami command
        #. Verify user from tested method same as user comes from command output
        """
        sal_user = self.ubuntu.whoami()
        rc2, os_user, err2 = j.sal.process.execute("whoami")
        self.assertEquals(os_user.strip(), sal_user)
